  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'quotes/new', name: 'quote-new', component: () => import('@/pages/QuoteEditorPage.vue') },
        { path: 'quotes/:id/edit', name: 'quote-edit', component: () => import('@/pages/QuoteEditorPage.vue') },
